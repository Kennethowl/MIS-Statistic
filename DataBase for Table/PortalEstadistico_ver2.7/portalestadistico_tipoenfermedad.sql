...
--
-- Table structure for table `tipoenfermedad`
--

DROP TABLE IF EXISTS `tipoenfermedad`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `tipoenfermedad` (
  `ID_TipoEnfermedad` int NOT NULL AUTO_INCREMENT,
  `Desc_Tipo` varchar(100) DEFAULT NULL,
  PRIMARY KEY (`ID_TipoEnfermedad`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `tipoenfermedad`
--

LOCK TABLES `tipoenfermedad` WRITE;
/*!40000 ALTER TABLE `tipoenfermedad` DISABLE KEYS */;
INSERT INTO `tipoenfermedad` VALUES (1,'Pandemia'),(2,'Epidemia');
...
-- Dump completed on 2022-11-26 20:35:44
