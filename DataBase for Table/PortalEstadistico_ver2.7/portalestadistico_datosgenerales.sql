...
CREATE TABLE `datosgenerales` (
  ...
  KEY `datosgenerales_ibfk_3_idx` (`ID_Indicadores`),
  CONSTRAINT `datosgenerales_ibfk_1` FOREIGN KEY (`ID_Municipio`) REFERENCES `municipios` (`ID_Municipio`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `datosgenerales_ibfk_2` FOREIGN KEY (`ID_Depto`) REFERENCES `departamentos` (`ID_Depto`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `datosgenerales_ibfk_3` FOREIGN KEY (`ID_Indicadores`) REFERENCES `indicadores` (`ID_Indicador`) ON DELETE CASCADE ON UPDATE CASCADE
...
-- Dump completed on 2022-11-26 20:35:25
