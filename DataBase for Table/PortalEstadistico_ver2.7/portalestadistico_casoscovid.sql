...
--
-- Table structure for table `casoscovid`
--
...
CREATE TABLE `casoscovid` (
  ...
  KEY `ID_Pais` (`ID_Pais`),
  CONSTRAINT `casoscovid_ibfk_1` FOREIGN KEY (`ID_Pais`) REFERENCES `paises` (`ID_pais`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `casoscovid`
--

LOCK TABLES `casoscovid` WRITE;
/*!40000 ALTER TABLE `casoscovid` DISABLE KEYS */;
/*!40000 ALTER TABLE `casoscovid` ENABLE KEYS */;
UNLOCK TABLES;
