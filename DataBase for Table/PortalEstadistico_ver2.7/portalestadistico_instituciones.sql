...
CREATE TABLE `instituciones` (
  ...
  KEY `instituciones_ibfk_1_idx` (`Categoria`),
  CONSTRAINT `instituciones_ibfk_1` FOREIGN KEY (`Categoria`) REFERENCES `tipoinstitucion` (`ID_tipoInstitucion`) ON DELETE CASCADE ON UPDATE CASCADE
...
-- Dump completed on 2022-11-26 20:35:27
